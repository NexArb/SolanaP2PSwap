    ...
    <Stack>
      <Stack className="relative">
        ...
        <Card
          elevation={0}
          radius="md"
          className={`absolute overflow-auto flex flex-col border dark:border-surfaceDark-dark border-surface-dark top-10 right-0 z-[999999991] w-44 max-h-32 p-3 pb-2 ${transClass}`}
