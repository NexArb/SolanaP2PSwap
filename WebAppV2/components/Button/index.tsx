...
export default function Button({
  ...
  const btnClass = useMemo(() => {
    ...
    const btnClass = [
      'cursor-pointer rounded-xxl flex flex-row items-center justify-center',
    ];
    ...
    if (disabled) {
      btnClass.push('text-surface-muted dark:text-surfaceDark-muted');
  ...
  const BtnIcon = () =>
    loading ? (
      ...
      <Icon icon={icon} size="md" disableDefaultColor />
    ) : (
      <></>
    );
